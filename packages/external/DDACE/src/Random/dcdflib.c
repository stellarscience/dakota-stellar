...
double betln(double *a0,double *b0)
/*
-----------------------------------------------------------------------
...
static double betln,a,b,c,h,u,v,w,z;
static int i,n;
static double T1;
/*
     ..
...
*/
    if(b >= 8.0e0) goto S10;
    T1 = a+b;
    betln = gamln(&a)+(gamln(&b)-gamln(&T1));
    return betln;
S10:
    betln = gamln(&a)+algdiv(&a,&b);
    return betln;
S20:
/*
-----------------------------------------------------------------------
...
*/
    if(a > 2.0e0) goto S40;
    if(b > 2.0e0) goto S30;
    betln = gamln(&a)+gamln(&b)-gsumln(&a,&b);
    return betln;
S30:
    w = 0.0e0;
    if(b < 8.0e0) goto S60;
...
*/
    ...
    betln = w+log(z)+(gamln(&a)+(gamln(&b)-gsumln(&a,&b)));
    return betln;
S80:
/*
...
*/
    ...
    betln = log(w)-(double)n*log(b)+(gamln(&a)+algdiv(&a,&b));
    return betln;
S100:
/*
-----------------------------------------------------------------------
...
*/
    ...
    v = b*alnrel(&h);
    if(u <= v) goto S110;
    betln = -(0.5e0*log(b))+e+w-v-u;
    return betln;
S110:
    betln = -(0.5e0*log(b))+e+w-u-v;
    return betln;
}
