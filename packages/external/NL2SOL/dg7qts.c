/* dg7qts.f -- translated by f2c (version 19970211).
...
/* Subroutine */ int dg7qts_(d__, dig, dihdi, ka, l, p, step, v, w)
doublereal *d__, *dig, *dihdi;
integer *ka;
doublereal *l;
integer *p;
doublereal *step, *v, *w;
