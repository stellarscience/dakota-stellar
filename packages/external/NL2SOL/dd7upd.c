/* dd7upd.f -- translated by f2c (version 19970211).
...
/* Subroutine */ int dd7upd_(d__, dr, iv, liv, lv, n, nd, nn, n2, p, v)
doublereal *d__, *dr;
integer *iv, *liv, *lv, *n, *nd, *nn, *n2, *p;
doublereal *v;
{
