/* df7hes.f -- translated by f2c (version 19970211).
...
/* Subroutine */ int df7hes_(d__, g, irt, iv, liv, lv, p, v, x)
doublereal *d__, *g;
integer *irt, *iv, *liv, *lv, *p;
doublereal *v, *x;
{
    ...
    /* Local variables */
    static integer kind, mm1o2, pp1o2, stpi, stpm, i__, k, l, m, gsave1;
    extern /* Subroutine */ int dv7cpy_();
    static integer mm1;
    static doublereal del;
    static integer hmi, hes, hpi, hpm, stp0;
