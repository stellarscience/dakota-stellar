/* dl7mst.f -- translated by f2c (version 19970211).
...
/* Table of constant values */
 ...
 static int
samephi(doublereal *x, doublereal *y)
{
	/* kludge for buggy gcc -O2 that may compare register and storage values */
	union {
		unsigned int u[2];
		doublereal d;
		} a, b;
	...
	if (a.d == b.d)
		return 1;
	if (sizeof(doublereal) == 2*sizeof(unsigned int)
	 && a.u[0] == b.u[0] && a.u[1] == b.u[1])
		return 1;
	return 0;
	}
...
/* Subroutine */ int dl7mst_(d__, g, ierr, ipivot, ka, p, qtr, r__, step, v, 
	w)
doublereal *d__, *g;
integer *ierr, *ipivot, *ka, *p;
doublereal *qtr, *r__, *step, *v, *w;
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int dl7ivm_();
    extern doublereal dd7tpr_(), dv2nrm_();
    extern /* Subroutine */ int dl7itv_();
