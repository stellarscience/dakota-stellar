/* dg7itb.f -- translated by f2c (version 19970211).
...
/* Subroutine */ int dg7itb_(b, d__, g, iv, liv, lv, p, ps, v, x, y)
doublereal *b, *d__, *g;
...
doublereal *v, *x, *y;
{
    ...
    extern /* Subroutine */ int df7dhb_();
    static integer p1, s1;
    static doublereal t1;
    static integer w1;
    extern logical stopx_();
    extern /* Subroutine */ int dg7qsb_(), dl7msb_(), ds7dmp_();
    extern doublereal dd7tpr_();
    extern /* Subroutine */ int da7sst_(), i7shft_(), dl7vml_();
    static integer g01;
    extern doublereal dv2nrm_();
    extern /* Subroutine */ int i7copy_(), dq7rsh_(), dl7sqr_(), dl7tvm_(), 
	    ds7ipr_(), ds7lup_();
    static doublereal gi;
    extern /* Subroutine */ int ds7lvm_(), dv2axy_(), dv7cpy_(), dv7ipr_(), 
	    i7pnvr_(), dv7scp_(), dv7vmp_();
    static integer x01;
