/* drn2g.f -- translated by f2c (version 19970211).
...
/* Subroutine */ int drn2g_(d__, dr, iv, liv, lv, n, nd, n1, n2, p, r__, rd, 
	v, x)
doublereal *d__, *dr;
integer *iv, *liv, *lv, *n, *nd, *n1, *n2, *p;
doublereal *r__, *rd, *v, *x;
{
    ...
    /* Local variables */
    static integer rmat1, jtol1, i__, k, l;
    static doublereal t;
    static integer g1, y1;
    extern /* Subroutine */ int dq7rad_(), dn2lrd_(), dc7vfn_(), dd7upd_(), 
	    dq7apl_(), dg7lit_(), dn2cvp_();
    extern doublereal dd7tpr_();
    extern /* Subroutine */ int dl7vml_(), dv7scp_();
    extern doublereal dv2nrm_();
    extern /* Subroutine */ int dv7cpy_();
    static integer gi, lh, nn, yi, ivmode;
    extern /* Subroutine */ int divset_(), ditsum_();
    static integer iv1, qtr1;
