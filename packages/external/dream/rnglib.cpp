...
//  Parameters:
//
//    Output, int I4_UNIFORM, the random integer.
//
{
  const int a1 = 40014;
  const int a2 = 40692;
...
//  Parameters:
//
//    Output, float R4_UNIFORM_01, a uniform random value in [0,1].
//
{
  int i;
  float value;
...
//  Purpose:
//
//    R8_UNIFORM_01 returns a uniform random double in [0,1].
//
//  Discussion:
//
...
//  Parameters:
//
//    Output, double R8_UNIFORM_01, a uniform random value in [0,1].
//
{
  int i;
  double value;
