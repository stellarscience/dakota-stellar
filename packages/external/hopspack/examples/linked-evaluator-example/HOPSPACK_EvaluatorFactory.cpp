...
{
    //---- IGNORE THE EVALUATOR TYPE PARAMETER AND RETURN AN INSTANCE
    //---- OF THE LINKED EVALUATOR.
    Evaluator *  pResult = (Evaluator *) new ExampleLinkedEvaluator (cEvalParams);
    return( pResult );

  /* ---- COMMENTING OUT THE DEFAULT FACTORY CODE
