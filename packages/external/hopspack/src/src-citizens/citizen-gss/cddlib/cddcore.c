/*
  $Id: cddcore.c 149 2009-11-12 02:40:41Z tplante $
  $URL: https://software.sandia.gov/svn/hopspack/trunk/src/src-citizens/citizen-gss/cddlib/cddcore.c $
*/
...
*/
{
  ...
  totalpairs=(float) ((cone->ZeroRayCount-1.0)*(cone->ZeroRayCount-2.0)+1.0);
  Ptr2begin = NULL; 
  ...
  do{
    ...
    Ptr1=Ptr1->Next;
    pos1++;
    workleft = (float) (100.0 * (cone->ZeroRayCount-pos1) * (cone->ZeroRayCount - pos1-1.0) / totalpairs);
