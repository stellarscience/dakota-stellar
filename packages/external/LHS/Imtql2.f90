...
cc  Function PYTHAG is included in POSDEF subroutine                    sld01
C     Added LHS_ prefix to avoid clash with LAPACK - BMA-13
cc  IMTQL2 is called from routine:  LHS_SSPEV                           sld01
cc  Note:  FYI error flag is not being checked in call from LHS_SSPEV   sld01
...
cc    PYTHAG is an external function (located in POSDEF subroutine)     sld01
C
...
C     .......... FORM SHIFT ..........
         G = (D(L+1) - P) / (2.0E0 * E(L))
C$$$  R = PYTHAG(G,1.0E0) ! Modified by slbrow, 2-19-2004
         R = PYTHAG(G,1.0D0)
