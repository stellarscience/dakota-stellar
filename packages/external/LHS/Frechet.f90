...
C****************************************************************
C SUBROUTINE FRECHET GENERATES FRECHET DISTRIBUTIONS
C WITH PARAMETERS ALPHA AND BETA
C
!LHS_EXPORT_DEC ATTRIBUTES DLLEXPORT::FRECHET
      SUBROUTINE FRECHET(J)
cc    FRECHET is called from:  LHS                                      sld01
cc    FRECHET calls routine:  RNUMLHS1                                  sld01
