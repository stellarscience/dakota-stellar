...
C***********************************************************************
C     Last change:  SLD  29 Mar 101   10:26 am
C****************************************************************
C SUBROUTINE TRED3 IS USED IN THE POSITIVE DEFINITE CHECK OF THE
C CORRELATION MATRIX
C
!LHS_EXPORT_DEC ATTRIBUTES DLLEXPORT::TRED3
      SUBROUTINE TRED3(N,NV,A,D,E,E2)
C     Added LHS_ prefix to avoid clash with LAPACK - BMA-13
cc    TRED3 is called from routine:  LHS_SSPEV                          sld01
cc    TRED3 does not call any other external routines                   sld01
